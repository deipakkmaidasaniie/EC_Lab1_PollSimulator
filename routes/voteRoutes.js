...
router.route('/vote').get((req, res) => {
  ...
  res.render('addVote', { candidates: candidates.candidatesNames, message: '' })
})
...
router.route('/vote').post((req, res, next) => {
  try {
    ...
    if (dataModel.findVoter(voter_id)) {
      res.render('addVote', { candidates: candidates.candidatesNames, message: 'Already Voted!' })
      return false
    }
    ...
    res.render('addVote', { candidates: candidates.candidatesNames, message: 'Successfully Voted!' })
  } catch (e) {
    console.log(e)
    res.render('addVote', { candidates: candidates.candidatesNames, message: 'Something went wrong..' })
